    ...
    render() {        
        ...
        return (
            <li className={"todoListItem checked-" + isCompleted + " edit-" + edit }>
                ...
                <div className="text" onDoubleClick={() => this.props.changeEdit(id)}>
                    {value}
                    {/* <input type="text" value={value}/> */}
                </div>        
                <input className="editInput" id={"editInput-id-" + id}  value={value} onChange={(event) => this.props.editText(event, id)} type="text" onBlur={() => this.props.changeEdit(id)}/>
